...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:sticky top-16 left-0 z-40 w-80 sm:w-96 h-[calc(100vh-4rem)] bg-stone-50 dark:bg-rajasthan-cardDark/90 border-r border-stone-200 dark:border-stone-800 flex flex-col transition-transform duration-300 ease-in-out ${
          isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
        }`}
      >
        {/* Subject Selector Header */}
        <div className="p-3 border-b border-stone-200 dark:border-stone-800 bg-white/60 dark:bg-stone-900/60 shrink-0">
          <label className="text-[11px] font-bold tracking-wider uppercase text-stone-500 dark:text-stone-400 mb-2 flex items-center justify-between">
            <span className="flex items-center gap-1.5">
              ...
              {language === 'hi' ? 'विषय चयन' : 'SELECT SUBJECT'}
            </span>
        ...
        <div className="px-3 py-2 bg-stone-100/70 dark:bg-stone-900/40 border-b border-stone-200 dark:border-stone-800 flex items-center justify-between gap-2 shrink-0">
          <span className="text-[11px] text-stone-500 font-medium flex items-center gap-1">
            ...
            {language === 'hi' ? 'परीक्षा फ़िल्टर:' : 'Filter:'}
          </span>
        ...
        {/* Units & Subtopics Tree (Scrollable) */}
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="w-full p-2.5 flex items-start justify-between text-left hover:bg-stone-50 dark:hover:bg-stone-800/50 transition-colors gap-2"
                >
                    ...
                    {filteredSubtopics.map(subtopic => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left px-3 py-2 flex items-center justify-between gap-2 text-xs transition-all ${
                            isSelected
